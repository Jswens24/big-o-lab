...
// ANSWER: yes, I would change it to the code below.  I think it will make the space better but not the time.

// const findFourth = (arr) => {
...
// ANSWER: i would create less variables by writing it like:
// const getNumbersSquared = (numArr) => {
//   let answersArr = [];
//   for (let i = 0; i < numArr.length; i++){
//     for (let j = i + 1; j < numArr.length; i++) {
//       answersArr.push(numArr[i] * numArr[j])
//     }
//   }
//   return answersArr
// }
...
// ANSWER: nothing is constant, it will all depend on what the string is
